...
include(${CMAKE_CURRENT_LIST_DIR}/module-GTestTargets.cmake)
...
set(GTest_VERSION_STRING "1.14.0")
set(GTest_INCLUDE_DIRS ${gtest_INCLUDE_DIRS_DEBUG} )
set(GTest_INCLUDE_DIR ${gtest_INCLUDE_DIRS_DEBUG} )
set(GTest_LIBRARIES ${gtest_LIBRARIES_DEBUG} )
set(GTest_DEFINITIONS ${gtest_DEFINITIONS_DEBUG} )
...
foreach(_BUILD_MODULE ${gtest_BUILD_MODULES_PATHS_DEBUG} )
